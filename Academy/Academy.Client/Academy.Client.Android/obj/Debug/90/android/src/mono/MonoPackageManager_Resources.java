...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Academy.Client.Android.dll" comes first in this list. */
		"Academy.Client.Android.dll",
		"Academy.Client.dll",
		"Academy.ClientDataLayer.dll",
		"Academy.UtilityAndModels.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"RestSharp.dll",
		"SQLite-net.dll",
